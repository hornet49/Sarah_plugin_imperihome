var action = function(data, callback, config, SARAH){ 
  ...
  request({ 'uri' : url }, function (err, response, body){
	...
	console.log(last);
	//var tts_imperihome = last.substring(last.indexOf('tts: ') +6, last.indexOf(', place') -1);
    callback(last);
	console.log(imperihome);
	
// Callback with Imperihome
    var url_imperihome = 'http://'+ip_imp+':8080/api/rest/speech/tts?text='+imperihome
    request({ 'uri' : url_imperihome })
// EndCallback with Imperihone
